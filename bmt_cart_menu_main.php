...
*/
	...
	<!-- ************ -->
	    ...
	    <div class="postbox">
	    	...
	    	<div class="inside">
	    		<p><strong><?php _e("Buy Now Button ","wordpress-paypal-shopping-cart"); ?></strong><?php _e("To add a 'Buy Now' button for a product, simply add the shortcode", "wordpress-simple-paypal-shopping-cart"); ?> [bmt_buy_now_button product_id="<?php _e("PRODUCT ID #", "wordpress-simple-paypal-shopping-cart"); ?>"] <?php _e("to a post or page next to the product. Replace PRODUCT-ID with the actual BMT Micro Product ID for your product. This option will go straight to the BMT checkout when the button is clicked.", "wordpress-simple-paypal-shopping-cart"); ?>
	    		...
	    		<p><strong><?php _e("Add to Cart Button ","wordpress-paypal-shopping-cart"); ?></strong><?php _e("To add an 'Add to Cart' button for your store or product, simply add the shortcode", "wordpress-simple-paypal-shopping-cart"); ?> [bmt_add_cart_button product_id="<?php _e("PRODUCT ID #", "wordpress-simple-paypal-shopping-cart"); ?>"] <?php _e("to a post or page next to the product. Replace PRODUCT ID with the actual BMT Micro Product ID for your product. This shortcode will send the product to the BMT server, populating the cart (quantities and discount codes are handled in the BMT Micro cart and products can also be deleted through there).", "wordpress-simple-paypal-shopping-cart"); ?>
	    		</p><p><?php _e("Example 'Add to Cart' button shortcode usage (keeps cart hidden):", "wordpress-simple-paypal-shopping-cart");?> <p style="background-color: #DDDDDD; padding: 5px; display: inline;">[bmt_add_cart_button product_id="0000"]</p>
					<p><?php _e("Example 'Add to Cart' button shortcode usage (displays the cart):", "wordpress-simple-paypal-shopping-cart");?> <p style="background-color: #DDDDDD; padding: 5px; display: inline;">[bmt_add_show_cart_button product_id="0000"]</p><p><?php _e("Then add this shortcode on the page to display the checkout button to route the customers to the BMT cart when they are ready to checkout:", "wordpress-simple-paypal-shopping-cart");?> <p style="background-color: #DDDDDD; padding: 5px; display: inline;">[bmt_checkout_button]</p><p><?php _e("This shortcode displays the checkout button to popup the BMT cart when they are ready to checkout:", "wordpress-simple-paypal-shopping-cart");?> <p style="background-color: #DDDDDD; padding: 5px; display: inline;">[bmt_checkout_button]</p></p>
			...
			<div class="inside">
				...
				<tr valign="top">
					...
					<th scope="row">'.(__("Buy Now Button text or Image", "wordpress-simple-paypal-shopping-cart")).'</th>
						<td><strong>'.(__(" This is only for vendors using 'Buy Now' option above. ", "wordpress-paypal-shopping-cart")).'</strong><br /><input type="text" name="buyNowButtonName" value="'.esc_attr($buynow).'" size="100" />
					...
					<th scope="row">'.(__("Add to Cart Button text or Image", "wordpress-simple-paypal-shopping-cart")).'</th>
						<td><strong>'.(__(" This is only for vendors using 'Add to Cart' option above. ", "wordpress-paypal-shopping-cart")).'</strong><br /><input type="text" name="addToCartButtonName" value="'.esc_attr($addcart).'" size="100" />
						<br />'.(__("To use a customized image as the button simply enter the URL of the image file (e.g.", "wordpress-simple-paypal-shopping-cart")).' http://www.your-domain.com/wp-content/plugins/wordpress-paypal-shopping-cart/images/buy_now_button.png).
						<br />
						</td>
					</tr>
					...
					<th scope="row">'.(__("Checkout Button text or Image", "wordpress-simple-paypal-shopping-cart")).'</th>
						<td><strong>'.(__("This is only for vendors using 'Checkout' option above. ", "wordpress-paypal-shopping-cart")).'</strong><br /><input type="text" name="checkoutButtonName" value="'.esc_attr($checkout).'" size="100" />
